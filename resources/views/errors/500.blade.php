...
<div class="mx-auto max-w-2xl px-4 py-16 text-center sm:px-6 lg:px-8">
    <h1 class="text-6xl font-bold text-gray-900 sm:text-8xl">500</h1>
    <p class="mt-4 text-lg text-gray-600">Something went wrong on our end. Please try again later.</p>
