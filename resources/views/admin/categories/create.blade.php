...
@section('content')
<h1 class="text-2xl font-semibold text-slate-800 mb-6">Add Category</h1>
<form action="{{ route('admin.categories.store') }}" method="POST" class="max-w-md space-y-4">
    @csrf
    <div>
    ...
    <div>
        ...
        <input type="text" name="slug" value="{{ old('slug') }}" placeholder="auto-generated" class="w-full rounded border-slate-300 shadow-sm">
    </div>
    <div>
    ...
    <div class="flex gap-3">
        <button type="submit" class="px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700">Create Category</button>
